...
function ResponsiveAppBar() {
    ...
    return (
        <AppBar id="main-header" position="static" sx={{ width: "100%", backgroundColor: "#cc5500" }}>
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    >
                        {title} {/* Dynamic title from context */}
                    </Typography>
                            ...
                            {pages.map((page) => (
                                <MenuItem key={page} onClick={handleCloseNavMenu}>
                                    <Typography textAlign="center">
                                        <Link
                                            to={page === "Home" ? "/" : `/${page.toLowerCase()}`} // Special case for Home
